...
var hasOwn = Object.prototype.hasOwnProperty,
  ...
  isPlainObject = function(t) {
    if (!t || '[object Object]' !== toStr.call(t)) return false
    var e,
    ...
    if (t.constructor && !r && !o) return false
    for (e in t);
    return undefined === e || hasOwn.call(t, e)
  },
          ...
          (o = getProperty(s, r)),
            s !== (n = getProperty(e, r)) &&
              (h && n && (isPlainObject(n) || (i = isArray(n)))
                ? (i
                    ? ((i = false), (a = o && isArray(o) ? o : []))
                    : (a = o && isPlainObject(o) ? o : {}),
                  setProperty(s, { name: r, newValue: t(h, a, n) }))
                : undefined !== n && setProperty(s, { name: r, newValue: n }))
    return s
  }
...
function QRPolynomial(t, e) {
  if (undefined == t.length) throw new Error(t.length + '/' + e)
          ...
          r.addData(utf16to8(t.text)),
            ...
            (e = t.ctx
              ...
              ? Taro.createCanvasContext &&
                Taro.createCanvasContext(t.canvasId, t._this)
              : Taro.createCanvasContext &&
                Taro.createCanvasContext(t.canvasId))
          for (
